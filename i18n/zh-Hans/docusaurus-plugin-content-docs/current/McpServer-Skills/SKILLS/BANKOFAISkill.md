...
| **ainft-skill** | v1.1.1 | AINFT 余额查询、订单记录、TRC20 充值 | `AINFT_API_KEY` |
...
你应该能看到 `sunswap`、`sunperp-skill`、`tronscan-skill`、`x402-payment`、`ainft-skill` 等目录。
