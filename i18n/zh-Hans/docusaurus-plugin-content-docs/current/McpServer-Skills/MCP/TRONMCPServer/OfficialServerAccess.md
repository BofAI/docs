...
TRON MCP Server 已停止新增开发，相关能力由 wallet-cli 承接。新接入请使用 [Wallet CLI 4.14 快速开始](/zh-Hans/wallet-cli/quickstart/) 和 [Skills 安装指南](/zh-Hans/McpServer-Skills/SKILLS/QuickStart/)。
...
<span id="什么是官方云服务"></span>
<span id="使用官方云服务的主要优点"></span>
<span id="如何接入官方云服务"></span>
<span id="方式一对话式安装最简单"></span>
<span id="方式二一键自动安装命令行"></span>
<span id="方式三交互式安装最精细控制"></span>
<span id="安装过程详解"></span>
<span id="验证接入是否成功"></span>
<span id="可用能力一览"></span>
<span id="下一步"></span>
