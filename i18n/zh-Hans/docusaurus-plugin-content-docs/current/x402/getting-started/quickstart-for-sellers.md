...
**预配置示例：** 我们提供了开箱即用的示例代码：[服务器示例](https://github.com/BofAI/x402-demo/tree/main/server) 和 [Facilitator 示例](https://github.com/BofAI/x402-demo/tree/main/facilitator)。您可以克隆仓库并直接运行它们！
...
| `schemes` | 每个价格对应的支付方案（列表）：`exact` | `["exact"]`                       |
...
- **使用[官方 Facilitator](https://github.com/BofAI/x402-facilitator)**
...
- [服务器示例](https://github.com/BofAI/x402-demo/tree/main/server)
- [Facilitator 示例](https://github.com/BofAI/x402-demo/tree/main/facilitator)
...
- 查看 [演示示例](https://github.com/BofAI/x402-demo/tree/main/server)，了解更复杂的支付流程。
