...
MCP Server 是 AI 助手与区块链之间的桥梁，通过 [Model Context Protocol (MCP)](../McpServer-Skills/MCP/Intro.md) 标准接口提供链上操作能力。目前支持三条链的 MCP Server 和一个远程服务：
...
| **ainft-skill** | AINFT 余额和订单查询，以及 TRC20 充值 |
