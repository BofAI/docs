...
| DeepSeek-V4-Flash | 闲时 `0.22`<br/>忙时 `0.44` | 闲时 `0.22`<br/>忙时 `0.44` | 闲时 `0.0073`<br/>忙时 `0.0147` | 闲时 `0.66`<br/>忙时 `1.32` | - |
| DeepSeek-V4-Flash-Vision-Exp | 闲时 `0.22`<br/>忙时 `0.44` | 闲时 `0.22`<br/>忙时 `0.44` | 闲时 `0.0073`<br/>忙时 `0.0147` | 闲时 `0.66`<br/>忙时 `1.32` | - |
