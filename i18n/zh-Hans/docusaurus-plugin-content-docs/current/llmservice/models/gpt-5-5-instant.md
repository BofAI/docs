...
| 模型名称 | 输入 (Credits/Token) | Cache Write (Credits/Token) | Cache Read (Credits/Token) | 输出 (Credits/Token) | 计费说明 |
| :--- | --------------------: | --------------------------: | -------------------------: | -------------------: | :--- |
| **GPT-5.5 Instant** | `5.00` | `5.00` | `0.50` | `30.00` | 长上下文（输入超过 272K）时，输入按 2 倍、输出按 1.5 倍计费 |
