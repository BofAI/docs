...
GLM-5.1 是由 Z.ai 开发的开源旗舰 AI 模型。Z.ai 前身为智谱 AI，源自清华大学，也是首家公开上市的基础模型公司。GLM-5.1 于 2026 年 4 月 7 日发布，是 GLM 系列的一次后训练升级，采用 7540 亿参数的 Mixture-of-Experts 架构，每个 token 激活约 400 亿参数，重点面向 Agent 工程与长周期自主软件开发场景。
