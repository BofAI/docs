...
| 上下文档位 | 输入<br/>（USD / 1M Tokens） | 缓存写入<br/>（USD / 1M Tokens） | 缓存读取<br/>（USD / 1M Tokens） | 输出<br/>（USD / 1M Tokens） | 网页搜索<br/>（USD / 次） | 计费说明 |
| :--- | --------------------: | --------------------------: | -------------------------: | -------------------: | ---: | :--- |
| 短上下文 | `$2.00` | `$2.50` | `$0.20` | `$12.00` | `$0.01` | GPT-5.6 Terra 标准价格 |
