...
Release notes for the x402 protocol, SDK, and [Wallet CLI guide](/wallet-cli/).
...
👉 [API Catalog Reference](/x402/api-catalog/reference/) · [List Your Service](/x402/api-catalog/list-your-service/) · [Wallet CLI guide](/wallet-cli/command-reference/)
...
👉 Get started: [Wallet CLI guide](/wallet-cli/quickstart/)
