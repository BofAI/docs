...
**Application Logic Layer**: The skills library serves as the AI agent's "brain and operation manual." It offers a series of reusable capability modules. Through structured instruction documents (SKILL.md), it teaches AI how to combine and call the underlying tools provided by MCP Server to complete complex business processes.
