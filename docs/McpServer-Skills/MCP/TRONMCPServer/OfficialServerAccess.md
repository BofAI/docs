...
TRON MCP Server no longer receives feature development; wallet-cli provides the replacement capabilities. For new integrations, use the [Wallet CLI 4.14 quick start](/wallet-cli/quickstart/) and [Skills installation guide](/McpServer-Skills/SKILLS/QuickStart/).
