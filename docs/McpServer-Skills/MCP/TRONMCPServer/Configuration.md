...
**Option C: Hosted Service (Read-Only)** Connect directly to the public hosted instance — no installation required.

**Service URL**: `https://tron-mcp-server.bankofai.io/mcp`
