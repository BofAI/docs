...
- **Reputation System**
  ...
  8004 defines a neutral public reputation storage standard that supports multidimensional feedback on Agents through structured signed data, while leaving the specific reputation algorithms, ranking aggregation, and anti-spam filtering logic entirely to the application layer of the ecosystem.
