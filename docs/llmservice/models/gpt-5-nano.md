...
## Overview
GPT-5-nano is an advanced language model that strikes an excellent balance between performance, speed, and cost. It is designed to provide capable AI performance at a moderate cost on B.AI.
