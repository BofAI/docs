...
Install wallet-cli 4.14.0 using the [quick start](/x402/cli/quickstart/), configure an account, and preview the route for your payment network. The examples below do not pay. Authorize any real payment separately and supply the password securely.
