...
The [`x402` repository](https://github.com/BofAI/x402) ships runnable client → server → facilitator trios under `examples/typescript/` for every scheme — `exact`, `gasfree`, `upto`, and `batch-settlement`.
